...
class Edit extends Component
{
    ...
    {
        return Dictionary::ofType('authority')->get();
    }

    #[Computed]
    public function rulers(): Collection
    {
        return Dictionary::ofType('ruler')->get();
    }

    #[Computed]
    public function regions(): Collection
    {
        return Dictionary::ofType('region')->get();
    }
    ...
    #[Computed]
    public function denominations(): Collection
    {
        return Dictionary::ofType('denomination')->get();
    }
    ...
    public function save(): void
    {
        ...
        if (is_array($this->newGallery)) {
            foreach ($this->newGallery as $file) {
                if ($file) {
                    $this->coin->addMedia($file)->toMediaCollection('gallery');
                }
            }
        }
        if (is_array($this->newDocuments)) {
            foreach ($this->newDocuments as $file) {
                if ($file) {
                    $this->coin->addMedia($file)->toMediaCollection('document');
                }
            }
        }
    ...
    {
        return view('exca-coin::pages.coins.edit')
