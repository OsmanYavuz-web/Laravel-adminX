...
<head>
    ...
    <title>500 - {{ __('Server Error') }} | {{ config('app.name', 'Laravel-adminX') }}</title>
...
<body class="min-h-screen bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center p-6 text-zinc-800 dark:text-zinc-200">
    <div class="max-w-md w-full text-center space-y-6">
        {{-- Icon Badge --}}
        <div class="inline-flex h-20 w-20 items-center justify-center rounded-3xl bg-rose-500/10 text-rose-500 dark:text-rose-400 border border-rose-500/20 shadow-xs">
        ...
        <div class="space-y-2">
            ...
            <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                {{ __('An unexpected error occurred on our server. Please try again later.') }}
            </p>
        </div>
